...
public class AmbulanceDriverMapActivity extends FragmentActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, com.google.android.gms.location.LocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ambulance_driver_map);
        // Obtain the SupportMapFragment and get notified when the map is ready to be used.
        SupportMapFragment mapFragment = (SupportMapFragment) getSupportFragmentManager()
                .findFragmentById(map);
        // Permission Ask
        if (ActivityCompat.checkSelfPermission(this, android.Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(this, android.Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(AmbulanceDriverMapActivity.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, LOCATION_REQUEST_CODE);
        } else {
        ...
        moptionsBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity(new Intent(AmbulanceDriverMapActivity.this, OptionsActivity.class));
                return;
            }
        });
    ...
    private void getAssignCustomer() {
        ...
        DatabaseReference assignedCustomerRef = FirebaseDatabase.getInstance().getReference().child("Users").child("Drivers").child(DriverID).child("CustomerRequest").child("AmbulanceRaidID");
    ...
    }// #Build End# get assigned Customer method.

    // getAssignCustomerPickUpLocation()
    private void getAssignCustomerPickUpLocation() {
        assignedCustomerPickUpRef = FirebaseDatabase.getInstance().getReference().child("AmbulanceRequests").child(CustomerId).child("l");
    ...
    // #Build Start# getAssignCustomerDestination method.
    ...
    }// #Build End# getAssignCustomerDestination method. #Build End# get Assign Customer Pick Up Location
    ...
    public void onLocationChanged(Location location) {
        if (getApplicationContext() != null) {
            ...
            DatabaseReference refAvailable = FirebaseDatabase.getInstance().getReference("AmbulanceDriversAvailable");
            DatabaseReference refWorking = FirebaseDatabase.getInstance().getReference("AmbulanceDriversWorking");
