...
public class SpecialCustomerMapActivity extends FragmentActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, com.google.android.gms.location.LocationListener {
    ...
    private Button mRequestSpecialBtn;
    ...
    private Boolean SpecialDriverFound = false;
    private String SpecialDriverFoundID;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_special_customer_map);
        // Obtain the SupportMapFragment and get notified when the map is ready to be used.
        SupportMapFragment mapFragment = (SupportMapFragment) getSupportFragmentManager()
                .findFragmentById(map);
        if (ActivityCompat.checkSelfPermission(this, android.Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(this, android.Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(SpecialCustomerMapActivity.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, LOCATION_REQUEST_CODE);
        } else {
            mapFragment.getMapAsync(this);
        }
        //Logout Setup and Ambulance Request Button
        mRequestSpecialBtn = findViewById(R.id.RequestSpecialBtn);
        ...
        mOptionsBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent OptionsIntent = new Intent(SpecialCustomerMapActivity.this, OptionsActivity.class);
        ...
        // Request Ambulance
        mRequestSpecialBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (requestBol) {
                    requestBol = false;
                    ...
                    if (SpecialDriverFoundID != null) {
                        DatabaseReference driverRef = FirebaseDatabase.getInstance().getReference().child("Users").child("Special").child(SpecialDriverFoundID).child("CustomerRequest");
                        // Question
                        driverRef.removeValue();
                        SpecialDriverFoundID = null;
                    }
                    SpecialDriverFound = false;
                    radius = 1;
                    // Remove from database
                    String userId = FirebaseAuth.getInstance().getCurrentUser().getUid();
                    DatabaseReference ref = FirebaseDatabase.getInstance().getReference("SpecialRequests");
                    ...
                    mRequestSpecialBtn.setText(R.string.RequestSpecial);
                    //Remove Driver Info
                    ...
                    // Change Button text
                    mRequestSpecialBtn.setText(R.string.Getspecial);
    ...
    private void getClosestDriver() {
        ...
        DatabaseReference AmbulanceDriverLocation = FirebaseDatabase.getInstance().getReference().child("SpecialDriversAvailable");
        ...
        geoQuery.addGeoQueryEventListener(new GeoQueryEventListener() {
            ...
            public void onKeyEntered(String key, GeoLocation location) {
                ...
                if (!SpecialDriverFound) {
                    SpecialDriverFound = true;
                    SpecialDriverFoundID = key;
                }
                //Notice Driver About Request
                DatabaseReference driverRef = FirebaseDatabase.getInstance().getReference().child("Users").child("Special").child(SpecialDriverFoundID).child("CustomerRequest");
                String CustomerID = FirebaseAuth.getInstance().getCurrentUser().getUid();
                HashMap Map = new HashMap();
                Map.put("SpecialRaidID", CustomerID);
                Map.put("Destination", Destination);
                driverRef.updateChildren(Map);
                //Get driver Location on Customer's Map
                getDriverLocation();
                getDriverInfo();
                mRequestSpecialBtn.setText(R.string.DriverLocation);
            }
    ...
    private void getDriverLocation() {
        driverLocationRef = FirebaseDatabase.getInstance().getReference().child("SpecialDriversWorking").child(SpecialDriverFoundID).child("l");
        ...
        driverLocationRefListener = driverLocationRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    mRequestSpecialBtn.setText(R.string.DriverFound);
                    ...
                    if (distance < 100) {
                        mRequestSpecialBtn.setText(R.string.DriverHere);
                    } else {
                        mRequestSpecialBtn.setText(R.string.CancelRequest + R.string.DriverDistance + String.valueOf(distance));
                    }
                    mDriverMarker = mMap.addMarker(new MarkerOptions().position(driverLatLng).title("Your Driver").icon(BitmapDescriptorFactory.fromResource(R.drawable.ic_mapimagespecial)));
                }
            }
    ...
    private void getDriverInfo() {
        ...
        DatabaseReference mCustomerDatabase = FirebaseDatabase.getInstance().getReference().child("Users").child("Special").child(SpecialDriverFoundID);
